...
3. При первом запуске:
   ...
   - Дождитесь проверки баланса
   - Сохраните показанный PIN-код

4. При последующих запусках:
   - Используйте сохраненный PIN-код для входа
   - Или нажмите "Сбросить ключ" для ввода нового API ключа

Если все установлено правильно, приложение должно запуститься на выбранном устройстве (эмулятор Android, iOS или Windows) и показать экран авторизации.
...
- PIN-код можно сбросить в любой момент через интерфейс приложения
